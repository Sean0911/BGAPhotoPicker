...
public class MomentAddActivity extends BGAPPToolbarActivity implements EasyPermissions.PermissionCallbacks, BGASortableNinePhotoLayout.Delegate {
    ...
    private void choicePhotoWrapper() {
        ...
        if (EasyPermissions.hasPermissions(this, perms)) {
            ...
            EasyPermissions.requestPermissions(this, "图片选择需要以下权限:\n\n1.访问设备上的照片\n\n2.调用设备上的相机", REQUEST_CODE_PERMISSION_PHOTO_PICKER, perms);
        }
    }
    ...
    public void onPermissionsDenied(int requestCode, List<String> perms) {
        ...
        if (EasyPermissions.somePermissionPermanentlyDenied(this, perms)) {
            new AppSettingsDialog.Builder(this).setTitle("权限请求").setRationale("没有此权限应用无法运行.请打开应用设置来修改应用权限").build().show();
        }
    }
